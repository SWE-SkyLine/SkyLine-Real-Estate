        ...
        <div className={commonStyle.allComponents}>
          ...
          <div className={style.ticketPage}>
            ...
            <div className={style.allItems}>
                ...
                <form className={commonStyle.Form} onSubmit={sendTicket}>
                    <div>
                        <label  className={commonStyle.head} >E-mail</label>
                        <input className={commonStyle.emailTextBox} placeholder="Enter Your Email ... example@gmail.com" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required/>
                    </div>
                    ...
                    {selectedOption === "REPORT" &&(
                        <div>
                            <label className={commonStyle.head} >Reported e-mail</label>
                            <input className={commonStyle.emailTextBox} type="email" value={reportEmail} onChange={(e) => setReportEmail(e.target.value)} required/>
                        </div> )
                    }

                    <div>
                        <label className={commonStyle.head}>Message</label>
                    ...
                    <button className={commonStyle.sendBtn} type="submit">Send</button>
                </form>
            </div>
        </div>    
        </div> 
